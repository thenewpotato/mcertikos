...
unsigned int syscall_get_arg1(void)
{
    ...
    return uctx_pool[current_id].regs.eax;
}

unsigned int syscall_get_arg2(void)
{
    unsigned int current_id = get_curid();
    return uctx_pool[current_id].regs.ebx;
}

unsigned int syscall_get_arg3(void)
{
    unsigned int current_id = get_curid();
    return uctx_pool[current_id].regs.ecx;
}

unsigned int syscall_get_arg4(void)
{
    unsigned int current_id = get_curid();
    return uctx_pool[current_id].regs.edx;
}

unsigned int syscall_get_arg5(void)
{
    unsigned int current_id = get_curid();
    return uctx_pool[current_id].regs.esi;
}

unsigned int syscall_get_arg6(void)
{
    unsigned int current_id = get_curid();
    return uctx_pool[current_id].regs.edi;
}
...
{
    unsigned int current_id = get_curid();
    uctx_pool[current_id].regs.eax = errno;
}
...
{
    unsigned int current_id = get_curid();
    uctx_pool[current_id].regs.ebx = retval;
}

void syscall_set_retval2(unsigned int retval)
{
    unsigned int current_id = get_curid();
    uctx_pool[current_id].regs.ecx = retval;
}

void syscall_set_retval3(unsigned int retval)
{
    unsigned int current_id = get_curid();
    uctx_pool[current_id].regs.edi = retval;
}

void syscall_set_retval4(unsigned int retval)
{
    unsigned int current_id = get_curid();
    uctx_pool[current_id].regs.esi = retval;
}
